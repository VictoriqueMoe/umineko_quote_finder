...
func buildTestQuotes() []ParsedQuote {
	return []ParsedQuote{
		...
		{Text: "Red truth", TextHtml: `<span class="red-truth">Red</span>`, CharacterID: "27", Episode: 2, TruthType: "red"},
		{Text: "Blue truth", TextHtml: `<span class="blue-truth">Blue</span>`, CharacterID: "10", Episode: 2, TruthType: "blue"},
		{Text: "Red truth ep3", TextHtml: `<span class="red-truth">Red</span>`, CharacterID: "10", Episode: 3, TruthType: "red"},
		{Text: "Blue truth ep3", TextHtml: `<span class="blue-truth">Blue</span>`, CharacterID: "27", Episode: 3, TruthType: "blue"},
